...
|---:|--------------------------|----------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x00000010|- opcode : fclass.s<br> - rd : x22<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br> |[0x8000011c]:fclass.s s6, fa7<br> [0x80000120]:csrrs a7, fflags, zero<br> [0x80000124]:sw s6, 0(a5)<br>     |
|   2|[0x80002218]<br>0x00000002|- rd : x9<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                          |[0x80000134]:fclass.s s1, fs9<br> [0x80000138]:csrrs a7, fflags, zero<br> [0x8000013c]:sw s1, 8(a5)<br>     |
|   3|[0x80002220]<br>0x00000040|- rd : x21<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x8000014c]:fclass.s s5, ft10<br> [0x80000150]:csrrs a7, fflags, zero<br> [0x80000154]:sw s5, 16(a5)<br>   |
|   4|[0x80002228]<br>0x00000100|- rd : x6<br> - rs1 : f31<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x2aaaaa and rm_val == 1  #nosat<br>                          |[0x80000164]:fclass.s t1, ft11<br> [0x80000168]:csrrs a7, fflags, zero<br> [0x8000016c]:sw t1, 24(a5)<br>   |
|   5|[0x80002230]<br>0x00000100|- rd : x31<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 1  #nosat<br>                          |[0x8000017c]:fclass.s t6, ft1<br> [0x80000180]:csrrs a7, fflags, zero<br> [0x80000184]:sw t6, 32(a5)<br>    |
|   6|[0x80002238]<br>0x00000200|- rd : x25<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x455555 and rm_val == 1  #nosat<br>                         |[0x80000194]:fclass.s s9, ft8<br> [0x80000198]:csrrs a7, fflags, zero<br> [0x8000019c]:sw s9, 40(a5)<br>    |
|   7|[0x80002240]<br>0x00000200|- rd : x13<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 1  #nosat<br>                          |[0x800001ac]:fclass.s a3, ft5<br> [0x800001b0]:csrrs a7, fflags, zero<br> [0x800001b4]:sw a3, 48(a5)<br>    |
|   8|[0x80002248]<br>0x00000200|- rd : x11<br> - rs1 : f26<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                         |[0x800001c4]:fclass.s a1, fs10<br> [0x800001c8]:csrrs a7, fflags, zero<br> [0x800001cc]:sw a1, 56(a5)<br>   |
|   9|[0x80002250]<br>0x00000200|- rd : x27<br> - rs1 : f9<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                          |[0x800001dc]:fclass.s s11, fs1<br> [0x800001e0]:csrrs a7, fflags, zero<br> [0x800001e4]:sw s11, 64(a5)<br>  |
|  10|[0x80002258]<br>0x00000001|- rd : x20<br> - rs1 : f27<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x800001f4]:fclass.s s4, fs11<br> [0x800001f8]:csrrs a7, fflags, zero<br> [0x800001fc]:sw s4, 72(a5)<br>   |
...
|  12|[0x80002268]<br>0x00000002|- rd : x14<br> - rs1 : f19<br> - fs1 == 1 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                         |[0x80000224]:fclass.s a4, fs3<br> [0x80000228]:csrrs a7, fflags, zero<br> [0x8000022c]:sw a4, 88(a5)<br>    |
|  13|[0x80002270]<br>0x00000040|- rd : x15<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                         |[0x80000248]:fclass.s a5, fs5<br> [0x8000024c]:csrrs s5, fflags, zero<br> [0x80000250]:sw a5, 0(s3)<br>     |
|  14|[0x80002278]<br>0x00000002|- rd : x3<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x055555 and rm_val == 1  #nosat<br>                           |[0x8000026c]:fclass.s gp, ft6<br> [0x80000270]:csrrs a7, fflags, zero<br> [0x80000274]:sw gp, 0(a5)<br>     |
|  15|[0x80002280]<br>0x00000040|- rd : x17<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                          |[0x80000290]:fclass.s a7, ft3<br> [0x80000294]:csrrs s5, fflags, zero<br> [0x80000298]:sw a7, 0(s3)<br>     |
|  16|[0x80002288]<br>0x00000002|- rd : x28<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x800002b4]:fclass.s t3, fs2<br> [0x800002b8]:csrrs a7, fflags, zero<br> [0x800002bc]:sw t3, 0(a5)<br>     |
|  17|[0x80002290]<br>0x00000000|- rd : x0<br> - rs1 : f15<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                          |[0x800002cc]:fclass.s zero, fa5<br> [0x800002d0]:csrrs a7, fflags, zero<br> [0x800002d4]:sw zero, 8(a5)<br> |
|  18|[0x80002298]<br>0x00000004|- rd : x24<br> - rs1 : f2<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                          |[0x800002e4]:fclass.s s8, ft2<br> [0x800002e8]:csrrs a7, fflags, zero<br> [0x800002ec]:sw s8, 16(a5)<br>    |
|  19|[0x800022a0]<br>0x00000020|- rd : x1<br> - rs1 : f12<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                          |[0x800002fc]:fclass.s ra, fa2<br> [0x80000300]:csrrs a7, fflags, zero<br> [0x80000304]:sw ra, 24(a5)<br>    |
|  20|[0x800022a8]<br>0x00000004|- rd : x4<br> - rs1 : f22<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7ffffe and rm_val == 1  #nosat<br>                          |[0x80000314]:fclass.s tp, fs6<br> [0x80000318]:csrrs a7, fflags, zero<br> [0x8000031c]:sw tp, 32(a5)<br>    |
|  21|[0x800022b0]<br>0x00000020|- rd : x12<br> - rs1 : f20<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000002 and rm_val == 1  #nosat<br>                         |[0x8000032c]:fclass.s a2, fs4<br> [0x80000330]:csrrs a7, fflags, zero<br> [0x80000334]:sw a2, 40(a5)<br>    |
|  22|[0x800022b8]<br>0x00000004|- rd : x19<br> - rs1 : f8<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                          |[0x80000344]:fclass.s s3, fs0<br> [0x80000348]:csrrs a7, fflags, zero<br> [0x8000034c]:sw s3, 48(a5)<br>    |
|  23|[0x800022c0]<br>0x00000020|- rd : x29<br> - rs1 : f14<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                         |[0x8000035c]:fclass.s t4, fa4<br> [0x80000360]:csrrs a7, fflags, zero<br> [0x80000364]:sw t4, 56(a5)<br>    |
|  24|[0x800022c8]<br>0x00000008|- rd : x30<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x80000374]:fclass.s t5, fa0<br> [0x80000378]:csrrs a7, fflags, zero<br> [0x8000037c]:sw t5, 64(a5)<br>    |
|  25|[0x800022d0]<br>0x00000010|- rd : x7<br> - rs1 : f16<br>                                                                                                     |[0x8000038c]:fclass.s t2, fa6<br> [0x80000390]:csrrs a7, fflags, zero<br> [0x80000394]:sw t2, 72(a5)<br>    |
|  26|[0x800022d8]<br>0x00000010|- rd : x2<br> - rs1 : f29<br>                                                                                                     |[0x800003a4]:fclass.s sp, ft9<br> [0x800003a8]:csrrs a7, fflags, zero<br> [0x800003ac]:sw sp, 80(a5)<br>    |
|  27|[0x800022e0]<br>0x00000010|- rd : x16<br> - rs1 : f24<br>                                                                                                    |[0x800003c8]:fclass.s a6, fs8<br> [0x800003cc]:csrrs s5, fflags, zero<br> [0x800003d0]:sw a6, 0(s3)<br>     |
|  28|[0x800022e8]<br>0x00000010|- rd : x8<br> - rs1 : f7<br>                                                                                                      |[0x800003ec]:fclass.s fp, ft7<br> [0x800003f0]:csrrs a7, fflags, zero<br> [0x800003f4]:sw fp, 0(a5)<br>     |
|  29|[0x800022f0]<br>0x00000010|- rd : x10<br> - rs1 : f11<br>                                                                                                    |[0x80000404]:fclass.s a0, fa1<br> [0x80000408]:csrrs a7, fflags, zero<br> [0x8000040c]:sw a0, 8(a5)<br>     |
|  30|[0x800022f8]<br>0x00000010|- rd : x5<br> - rs1 : f13<br>                                                                                                     |[0x8000041c]:fclass.s t0, fa3<br> [0x80000420]:csrrs a7, fflags, zero<br> [0x80000424]:sw t0, 16(a5)<br>    |
...
|  32|[0x80002308]<br>0x00000010|- rd : x23<br> - rs1 : f4<br>                                                                                                     |[0x8000044c]:fclass.s s7, ft4<br> [0x80000450]:csrrs a7, fflags, zero<br> [0x80000454]:sw s7, 32(a5)<br>    |
