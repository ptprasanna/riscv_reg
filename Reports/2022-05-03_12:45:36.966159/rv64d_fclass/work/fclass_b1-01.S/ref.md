...
|---:|----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0x0000000000000010|- opcode : fclass.d<br> - rd : x10<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br> |[0x800003b4]:fclass.d a0, fs10<br> [0x800003b8]:csrrs a7, fflags, zero<br> [0x800003bc]:sd a0, 0(a5)<br>     |
|   2|[0x80002320]<br>0x0000000000000000|- rd : x0<br> - rs1 : f22<br> - fs1 == 1 and fe1 == 0x3f8 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x800003cc]:fclass.d zero, fs6<br> [0x800003d0]:csrrs a7, fflags, zero<br> [0x800003d4]:sd zero, 16(a5)<br> |
|   3|[0x80002330]<br>0x0000000000000040|- rd : x2<br> - rs1 : f18<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x800003e4]:fclass.d sp, fs2<br> [0x800003e8]:csrrs a7, fflags, zero<br> [0x800003ec]:sd sp, 32(a5)<br>     |
|   4|[0x80002340]<br>0x0000000000000100|- rd : x26<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                         |[0x800003fc]:fclass.d s10, fa5<br> [0x80000400]:csrrs a7, fflags, zero<br> [0x80000404]:sd s10, 48(a5)<br>   |
|   5|[0x80002350]<br>0x0000000000000100|- rd : x5<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                          |[0x80000414]:fclass.d t0, fs3<br> [0x80000418]:csrrs a7, fflags, zero<br> [0x8000041c]:sd t0, 64(a5)<br>     |
|   6|[0x80002360]<br>0x0000000000000200|- rd : x23<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 1  #nosat<br>                         |[0x8000042c]:fclass.d s7, ft8<br> [0x80000430]:csrrs a7, fflags, zero<br> [0x80000434]:sd s7, 80(a5)<br>     |
|   7|[0x80002370]<br>0x0000000000000200|- rd : x27<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 1  #nosat<br>                         |[0x80000444]:fclass.d s11, fa7<br> [0x80000448]:csrrs a7, fflags, zero<br> [0x8000044c]:sd s11, 96(a5)<br>   |
|   8|[0x80002380]<br>0x0000000000000200|- rd : x29<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 1  #nosat<br>                         |[0x8000045c]:fclass.d t4, ft9<br> [0x80000460]:csrrs a7, fflags, zero<br> [0x80000464]:sd t4, 112(a5)<br>    |
|   9|[0x80002390]<br>0x0000000000000200|- rd : x8<br> - rs1 : f3<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 1  #nosat<br>                           |[0x80000474]:fclass.d fp, ft3<br> [0x80000478]:csrrs a7, fflags, zero<br> [0x8000047c]:sd fp, 128(a5)<br>    |
|  10|[0x800023a0]<br>0x0000000000000001|- rd : x15<br> - rs1 : f4<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x80000498]:fclass.d a5, ft4<br> [0x8000049c]:csrrs s5, fflags, zero<br> [0x800004a0]:sd a5, 0(s3)<br>      |
|  11|[0x800023b0]<br>0x0000000000000080|- rd : x28<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x800004bc]:fclass.d t3, fs0<br> [0x800004c0]:csrrs a7, fflags, zero<br> [0x800004c4]:sd t3, 0(a5)<br>      |
|  12|[0x800023c0]<br>0x0000000000000002|- rd : x12<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                          |[0x800004d4]:fclass.d a2, fs1<br> [0x800004d8]:csrrs a7, fflags, zero<br> [0x800004dc]:sd a2, 16(a5)<br>     |
|  13|[0x800023d0]<br>0x0000000000000040|- rd : x30<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                          |[0x800004ec]:fclass.d t5, ft2<br> [0x800004f0]:csrrs a7, fflags, zero<br> [0x800004f4]:sd t5, 32(a5)<br>     |
|  14|[0x800023e0]<br>0x0000000000000002|- rd : x25<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                         |[0x80000504]:fclass.d s9, fs4<br> [0x80000508]:csrrs a7, fflags, zero<br> [0x8000050c]:sd s9, 48(a5)<br>     |
|  15|[0x800023f0]<br>0x0000000000000040|- rd : x20<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                         |[0x8000051c]:fclass.d s4, ft10<br> [0x80000520]:csrrs a7, fflags, zero<br> [0x80000524]:sd s4, 64(a5)<br>    |
|  16|[0x80002400]<br>0x0000000000000002|- rd : x31<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                         |[0x80000534]:fclass.d t6, fa4<br> [0x80000538]:csrrs a7, fflags, zero<br> [0x8000053c]:sd t6, 80(a5)<br>     |
|  17|[0x80002410]<br>0x0000000000000040|- rd : x14<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                          |[0x8000054c]:fclass.d a4, ft6<br> [0x80000550]:csrrs a7, fflags, zero<br> [0x80000554]:sd a4, 96(a5)<br>     |
|  18|[0x80002420]<br>0x0000000000000004|- rd : x24<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                         |[0x80000564]:fclass.d s8, fs9<br> [0x80000568]:csrrs a7, fflags, zero<br> [0x8000056c]:sd s8, 112(a5)<br>    |
|  19|[0x80002430]<br>0x0000000000000020|- rd : x17<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                          |[0x80000588]:fclass.d a7, ft5<br> [0x8000058c]:csrrs s5, fflags, zero<br> [0x80000590]:sd a7, 0(s3)<br>      |
|  20|[0x80002440]<br>0x0000000000000004|- rd : x18<br> - rs1 : f10<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                         |[0x800005ac]:fclass.d s2, fa0<br> [0x800005b0]:csrrs a7, fflags, zero<br> [0x800005b4]:sd s2, 0(a5)<br>      |
|  21|[0x80002450]<br>0x0000000000000020|- rd : x7<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                          |[0x800005c4]:fclass.d t2, fs11<br> [0x800005c8]:csrrs a7, fflags, zero<br> [0x800005cc]:sd t2, 16(a5)<br>    |
|  22|[0x80002460]<br>0x0000000000000004|- rd : x11<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                         |[0x800005dc]:fclass.d a1, fs7<br> [0x800005e0]:csrrs a7, fflags, zero<br> [0x800005e4]:sd a1, 32(a5)<br>     |
|  23|[0x80002470]<br>0x0000000000000020|- rd : x1<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                          |[0x800005f4]:fclass.d ra, ft11<br> [0x800005f8]:csrrs a7, fflags, zero<br> [0x800005fc]:sd ra, 48(a5)<br>    |
|  24|[0x80002480]<br>0x0000000000000008|- rd : x6<br> - rs1 : f1<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                           |[0x8000060c]:fclass.d t1, ft1<br> [0x80000610]:csrrs a7, fflags, zero<br> [0x80000614]:sd t1, 64(a5)<br>     |
|  25|[0x80002490]<br>0x0000000000000010|- rd : x3<br> - rs1 : f16<br>                                                                                                             |[0x80000624]:fclass.d gp, fa6<br> [0x80000628]:csrrs a7, fflags, zero<br> [0x8000062c]:sd gp, 80(a5)<br>     |
|  26|[0x800024a0]<br>0x0000000000000010|- rd : x21<br> - rs1 : f13<br>                                                                                                            |[0x8000063c]:fclass.d s5, fa3<br> [0x80000640]:csrrs a7, fflags, zero<br> [0x80000644]:sd s5, 96(a5)<br>     |
|  27|[0x800024b0]<br>0x0000000000000010|- rd : x19<br> - rs1 : f11<br>                                                                                                            |[0x80000654]:fclass.d s3, fa1<br> [0x80000658]:csrrs a7, fflags, zero<br> [0x8000065c]:sd s3, 112(a5)<br>    |
|  28|[0x800024c0]<br>0x0000000000000010|- rd : x16<br> - rs1 : f7<br>                                                                                                             |[0x80000678]:fclass.d a6, ft7<br> [0x8000067c]:csrrs s5, fflags, zero<br> [0x80000680]:sd a6, 0(s3)<br>      |
|  29|[0x800024d0]<br>0x0000000000000010|- rd : x4<br> - rs1 : f12<br>                                                                                                             |[0x8000069c]:fclass.d tp, fa2<br> [0x800006a0]:csrrs a7, fflags, zero<br> [0x800006a4]:sd tp, 0(a5)<br>      |
|  30|[0x800024e0]<br>0x0000000000000010|- rd : x22<br> - rs1 : f21<br>                                                                                                            |[0x800006b4]:fclass.d s6, fs5<br> [0x800006b8]:csrrs a7, fflags, zero<br> [0x800006bc]:sd s6, 16(a5)<br>     |
|  31|[0x800024f0]<br>0x0000000000000010|- rd : x13<br> - rs1 : f24<br>                                                                                                            |[0x800006cc]:fclass.d a3, fs8<br> [0x800006d0]:csrrs a7, fflags, zero<br> [0x800006d4]:sd a3, 32(a5)<br>     |
|  32|[0x80002500]<br>0x0000000000000010|- rd : x9<br> - rs1 : f0<br>                                                                                                              |[0x800006e4]:fclass.d s1, ft0<br> [0x800006e8]:csrrs a7, fflags, zero<br> [0x800006ec]:sd s1, 48(a5)<br>     |
