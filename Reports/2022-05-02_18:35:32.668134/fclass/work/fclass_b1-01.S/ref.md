...
|---:|--------------------------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x00000010|- opcode : fclass.s<br> - rd : x1<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br> |[0x8000011c]:fclass.s ra, ft6<br> [0x80000120]:csrrs a7, fflags, zero<br> [0x80000124]:sw ra, 0(a5)<br>      |
|   2|[0x80002218]<br>0x00000002|- rd : x13<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                       |[0x80000134]:fclass.s a3, fs7<br> [0x80000138]:csrrs a7, fflags, zero<br> [0x8000013c]:sw a3, 8(a5)<br>      |
|   3|[0x80002220]<br>0x00000040|- rd : x29<br> - rs1 : f2<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                        |[0x8000014c]:fclass.s t4, ft2<br> [0x80000150]:csrrs a7, fflags, zero<br> [0x80000154]:sw t4, 16(a5)<br>     |
|   4|[0x80002228]<br>0x00000100|- rd : x23<br> - rs1 : f30<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x2aaaaa and rm_val == 1  #nosat<br>                       |[0x80000164]:fclass.s s7, ft10<br> [0x80000168]:csrrs a7, fflags, zero<br> [0x8000016c]:sw s7, 24(a5)<br>    |
...
|   6|[0x80002238]<br>0x00000200|- rd : x28<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x455555 and rm_val == 1  #nosat<br>                       |[0x80000194]:fclass.s t3, fs9<br> [0x80000198]:csrrs a7, fflags, zero<br> [0x8000019c]:sw t3, 40(a5)<br>     |
|   7|[0x80002240]<br>0x00000200|- rd : x19<br> - rs1 : f19<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 1  #nosat<br>                       |[0x800001ac]:fclass.s s3, fs3<br> [0x800001b0]:csrrs a7, fflags, zero<br> [0x800001b4]:sw s3, 48(a5)<br>     |
|   8|[0x80002248]<br>0x00000200|- rd : x9<br> - rs1 : f8<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                         |[0x800001c4]:fclass.s s1, fs0<br> [0x800001c8]:csrrs a7, fflags, zero<br> [0x800001cc]:sw s1, 56(a5)<br>     |
|   9|[0x80002250]<br>0x00000200|- rd : x25<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                        |[0x800001dc]:fclass.s s9, ft5<br> [0x800001e0]:csrrs a7, fflags, zero<br> [0x800001e4]:sw s9, 64(a5)<br>     |
|  10|[0x80002258]<br>0x00000001|- rd : x30<br> - rs1 : f7<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 1  #nosat<br>                        |[0x800001f4]:fclass.s t5, ft7<br> [0x800001f8]:csrrs a7, fflags, zero<br> [0x800001fc]:sw t5, 72(a5)<br>     |
|  11|[0x80002260]<br>0x00000080|- rd : x10<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 1  #nosat<br>                       |[0x8000020c]:fclass.s a0, fs11<br> [0x80000210]:csrrs a7, fflags, zero<br> [0x80000214]:sw a0, 80(a5)<br>    |
|  12|[0x80002268]<br>0x00000002|- rd : x15<br> - rs1 : f14<br> - fs1 == 1 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                       |[0x80000230]:fclass.s a5, fa4<br> [0x80000234]:csrrs s5, fflags, zero<br> [0x80000238]:sw a5, 0(s3)<br>      |
|  13|[0x80002270]<br>0x00000040|- rd : x8<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                         |[0x80000254]:fclass.s fp, ft1<br> [0x80000258]:csrrs a7, fflags, zero<br> [0x8000025c]:sw fp, 0(a5)<br>      |
|  14|[0x80002278]<br>0x00000002|- rd : x11<br> - rs1 : f12<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x055555 and rm_val == 1  #nosat<br>                       |[0x8000026c]:fclass.s a1, fa2<br> [0x80000270]:csrrs a7, fflags, zero<br> [0x80000274]:sw a1, 8(a5)<br>      |
|  15|[0x80002280]<br>0x00000000|- rd : x0<br> - rs1 : f20<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                        |[0x80000284]:fclass.s zero, fs4<br> [0x80000288]:csrrs a7, fflags, zero<br> [0x8000028c]:sw zero, 16(a5)<br> |
|  16|[0x80002288]<br>0x00000002|- rd : x7<br> - rs1 : f21<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                        |[0x8000029c]:fclass.s t2, fs5<br> [0x800002a0]:csrrs a7, fflags, zero<br> [0x800002a4]:sw t2, 24(a5)<br>     |
|  17|[0x80002290]<br>0x00000040|- rd : x5<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                        |[0x800002b4]:fclass.s t0, fa7<br> [0x800002b8]:csrrs a7, fflags, zero<br> [0x800002bc]:sw t0, 32(a5)<br>     |
|  18|[0x80002298]<br>0x00000004|- rd : x16<br> - rs1 : f13<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                       |[0x800002d8]:fclass.s a6, fa3<br> [0x800002dc]:csrrs s5, fflags, zero<br> [0x800002e0]:sw a6, 0(s3)<br>      |
|  19|[0x800022a0]<br>0x00000020|- rd : x27<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                       |[0x800002fc]:fclass.s s11, fa1<br> [0x80000300]:csrrs a7, fflags, zero<br> [0x80000304]:sw s11, 0(a5)<br>    |
|  20|[0x800022a8]<br>0x00000004|- rd : x4<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7ffffe and rm_val == 1  #nosat<br>                        |[0x80000314]:fclass.s tp, ft9<br> [0x80000318]:csrrs a7, fflags, zero<br> [0x8000031c]:sw tp, 8(a5)<br>      |
|  21|[0x800022b0]<br>0x00000020|- rd : x18<br> - rs1 : f24<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000002 and rm_val == 1  #nosat<br>                       |[0x8000032c]:fclass.s s2, fs8<br> [0x80000330]:csrrs a7, fflags, zero<br> [0x80000334]:sw s2, 16(a5)<br>     |
|  22|[0x800022b8]<br>0x00000004|- rd : x17<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                       |[0x80000350]:fclass.s a7, fs2<br> [0x80000354]:csrrs s5, fflags, zero<br> [0x80000358]:sw a7, 0(s3)<br>      |
|  23|[0x800022c0]<br>0x00000020|- rd : x22<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                       |[0x80000374]:fclass.s s6, fa0<br> [0x80000378]:csrrs a7, fflags, zero<br> [0x8000037c]:sw s6, 0(a5)<br>      |
|  24|[0x800022c8]<br>0x00000008|- rd : x14<br> - rs1 : f0<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                        |[0x8000038c]:fclass.s a4, ft0<br> [0x80000390]:csrrs a7, fflags, zero<br> [0x80000394]:sw a4, 8(a5)<br>      |
|  25|[0x800022d0]<br>0x00000010|- rd : x21<br> - rs1 : f22<br>                                                                                                  |[0x800003a4]:fclass.s s5, fs6<br> [0x800003a8]:csrrs a7, fflags, zero<br> [0x800003ac]:sw s5, 16(a5)<br>     |
|  26|[0x800022d8]<br>0x00000010|- rd : x31<br> - rs1 : f26<br>                                                                                                  |[0x800003bc]:fclass.s t6, fs10<br> [0x800003c0]:csrrs a7, fflags, zero<br> [0x800003c4]:sw t6, 24(a5)<br>    |
|  27|[0x800022e0]<br>0x00000010|- rd : x12<br> - rs1 : f31<br>                                                                                                  |[0x800003d4]:fclass.s a2, ft11<br> [0x800003d8]:csrrs a7, fflags, zero<br> [0x800003dc]:sw a2, 32(a5)<br>    |
|  28|[0x800022e8]<br>0x00000010|- rd : x20<br> - rs1 : f4<br>                                                                                                   |[0x800003ec]:fclass.s s4, ft4<br> [0x800003f0]:csrrs a7, fflags, zero<br> [0x800003f4]:sw s4, 40(a5)<br>     |
|  29|[0x800022f0]<br>0x00000010|- rd : x24<br> - rs1 : f28<br>                                                                                                  |[0x80000404]:fclass.s s8, ft8<br> [0x80000408]:csrrs a7, fflags, zero<br> [0x8000040c]:sw s8, 48(a5)<br>     |
|  30|[0x800022f8]<br>0x00000010|- rd : x6<br> - rs1 : f9<br>                                                                                                    |[0x8000041c]:fclass.s t1, fs1<br> [0x80000420]:csrrs a7, fflags, zero<br> [0x80000424]:sw t1, 56(a5)<br>     |
|  31|[0x80002300]<br>0x00000010|- rd : x3<br> - rs1 : f15<br>                                                                                                   |[0x80000434]:fclass.s gp, fa5<br> [0x80000438]:csrrs a7, fflags, zero<br> [0x8000043c]:sw gp, 64(a5)<br>     |
|  32|[0x80002308]<br>0x00000010|- rd : x2<br> - rs1 : f16<br>                                                                                                   |[0x8000044c]:fclass.s sp, fa6<br> [0x80000450]:csrrs a7, fflags, zero<br> [0x80000454]:sw sp, 72(a5)<br>     |
