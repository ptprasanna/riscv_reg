...
|---:|--------------------------|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002210]<br>0x00000010|- opcode : fclass.s<br> - rd : x16<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br> |[0x8000011c]:fclass.s a6, fa1<br> [0x80000120]:csrrs s5, fflags, zero<br> [0x80000124]:sw a6, 0(s3)<br>      |
|   2|[0x80002218]<br>0x00000002|- rd : x3<br> - rs1 : f6<br> - fs1 == 1 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                           |[0x80000140]:fclass.s gp, ft6<br> [0x80000144]:csrrs a7, fflags, zero<br> [0x80000148]:sw gp, 0(a5)<br>      |
|   3|[0x80002220]<br>0x00000040|- rd : x18<br> - rs1 : f16<br> - fs1 == 0 and fe1 == 0x7f and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x80000158]:fclass.s s2, fa6<br> [0x8000015c]:csrrs a7, fflags, zero<br> [0x80000160]:sw s2, 8(a5)<br>      |
|   4|[0x80002228]<br>0x00000000|- rd : x0<br> - rs1 : f12<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x2aaaaa and rm_val == 1  #nosat<br>                          |[0x80000170]:fclass.s zero, fa2<br> [0x80000174]:csrrs a7, fflags, zero<br> [0x80000178]:sw zero, 16(a5)<br> |
|   5|[0x80002230]<br>0x00000100|- rd : x9<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000001 and rm_val == 1  #nosat<br>                           |[0x80000188]:fclass.s s1, ft5<br> [0x8000018c]:csrrs a7, fflags, zero<br> [0x80000190]:sw s1, 24(a5)<br>     |
|   6|[0x80002238]<br>0x00000200|- rd : x5<br> - rs1 : f2<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x455555 and rm_val == 1  #nosat<br>                           |[0x800001a0]:fclass.s t0, ft2<br> [0x800001a4]:csrrs a7, fflags, zero<br> [0x800001a8]:sw t0, 32(a5)<br>     |
|   7|[0x80002240]<br>0x00000200|- rd : x2<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400001 and rm_val == 1  #nosat<br>                          |[0x800001b8]:fclass.s sp, fs5<br> [0x800001bc]:csrrs a7, fflags, zero<br> [0x800001c0]:sw sp, 40(a5)<br>     |
|   8|[0x80002248]<br>0x00000200|- rd : x24<br> - rs1 : f17<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                         |[0x800001d0]:fclass.s s8, fa7<br> [0x800001d4]:csrrs a7, fflags, zero<br> [0x800001d8]:sw s8, 48(a5)<br>     |
|   9|[0x80002250]<br>0x00000200|- rd : x31<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x400000 and rm_val == 1  #nosat<br>                         |[0x800001e8]:fclass.s t6, fa0<br> [0x800001ec]:csrrs a7, fflags, zero<br> [0x800001f0]:sw t6, 56(a5)<br>     |
|  10|[0x80002258]<br>0x00000001|- rd : x27<br> - rs1 : f8<br> - fs1 == 1 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 1  #nosat<br>                          |[0x80000200]:fclass.s s11, fs0<br> [0x80000204]:csrrs a7, fflags, zero<br> [0x80000208]:sw s11, 64(a5)<br>   |
|  11|[0x80002260]<br>0x00000080|- rd : x25<br> - rs1 : f29<br> - fs1 == 0 and fe1 == 0xff and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x80000218]:fclass.s s9, ft9<br> [0x8000021c]:csrrs a7, fflags, zero<br> [0x80000220]:sw s9, 72(a5)<br>     |
|  12|[0x80002268]<br>0x00000002|- rd : x19<br> - rs1 : f18<br> - fs1 == 1 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                         |[0x80000230]:fclass.s s3, fs2<br> [0x80000234]:csrrs a7, fflags, zero<br> [0x80000238]:sw s3, 80(a5)<br>     |
|  13|[0x80002270]<br>0x00000040|- rd : x15<br> - rs1 : f1<br> - fs1 == 0 and fe1 == 0xfe and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                          |[0x80000254]:fclass.s a5, ft1<br> [0x80000258]:csrrs s5, fflags, zero<br> [0x8000025c]:sw a5, 0(s3)<br>      |
|  14|[0x80002278]<br>0x00000002|- rd : x13<br> - rs1 : f15<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x055555 and rm_val == 1  #nosat<br>                         |[0x80000278]:fclass.s a3, fa5<br> [0x8000027c]:csrrs a7, fflags, zero<br> [0x80000280]:sw a3, 0(a5)<br>      |
|  15|[0x80002280]<br>0x00000040|- rd : x23<br> - rs1 : f26<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                         |[0x80000290]:fclass.s s7, fs10<br> [0x80000294]:csrrs a7, fflags, zero<br> [0x80000298]:sw s7, 8(a5)<br>     |
|  16|[0x80002288]<br>0x00000002|- rd : x21<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                          |[0x800002a8]:fclass.s s5, fs1<br> [0x800002ac]:csrrs a7, fflags, zero<br> [0x800002b0]:sw s5, 16(a5)<br>     |
|  17|[0x80002290]<br>0x00000040|- rd : x30<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x01 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x800002c0]:fclass.s t5, fs11<br> [0x800002c4]:csrrs a7, fflags, zero<br> [0x800002c8]:sw t5, 24(a5)<br>    |
|  18|[0x80002298]<br>0x00000004|- rd : x10<br> - rs1 : f23<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                         |[0x800002d8]:fclass.s a0, fs7<br> [0x800002dc]:csrrs a7, fflags, zero<br> [0x800002e0]:sw a0, 32(a5)<br>     |
|  19|[0x800022a0]<br>0x00000020|- rd : x7<br> - rs1 : f30<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x7fffff and rm_val == 1  #nosat<br>                          |[0x800002f0]:fclass.s t2, ft10<br> [0x800002f4]:csrrs a7, fflags, zero<br> [0x800002f8]:sw t2, 40(a5)<br>    |
|  20|[0x800022a8]<br>0x00000004|- rd : x12<br> - rs1 : f7<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x7ffffe and rm_val == 1  #nosat<br>                          |[0x80000308]:fclass.s a2, ft7<br> [0x8000030c]:csrrs a7, fflags, zero<br> [0x80000310]:sw a2, 48(a5)<br>     |
|  21|[0x800022b0]<br>0x00000020|- rd : x1<br> - rs1 : f31<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000002 and rm_val == 1  #nosat<br>                          |[0x80000320]:fclass.s ra, ft11<br> [0x80000324]:csrrs a7, fflags, zero<br> [0x80000328]:sw ra, 56(a5)<br>    |
|  22|[0x800022b8]<br>0x00000004|- rd : x20<br> - rs1 : f20<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                         |[0x80000338]:fclass.s s4, fs4<br> [0x8000033c]:csrrs a7, fflags, zero<br> [0x80000340]:sw s4, 64(a5)<br>     |
|  23|[0x800022c0]<br>0x00000020|- rd : x28<br> - rs1 : f28<br> - fs1 == 0 and fe1 == 0x00 and fm1 == 0x000001 and rm_val == 1  #nosat<br>                         |[0x80000350]:fclass.s t3, ft8<br> [0x80000354]:csrrs a7, fflags, zero<br> [0x80000358]:sw t3, 72(a5)<br>     |
|  24|[0x800022c8]<br>0x00000008|- rd : x29<br> - rs1 : f22<br> - fs1 == 1 and fe1 == 0x00 and fm1 == 0x000000 and rm_val == 1  #nosat<br>                         |[0x80000368]:fclass.s t4, fs6<br> [0x8000036c]:csrrs a7, fflags, zero<br> [0x80000370]:sw t4, 80(a5)<br>     |
|  25|[0x800022d0]<br>0x00000010|- rd : x14<br> - rs1 : f4<br>                                                                                                     |[0x80000380]:fclass.s a4, ft4<br> [0x80000384]:csrrs a7, fflags, zero<br> [0x80000388]:sw a4, 88(a5)<br>     |
|  26|[0x800022d8]<br>0x00000010|- rd : x17<br> - rs1 : f25<br>                                                                                                    |[0x800003a4]:fclass.s a7, fs9<br> [0x800003a8]:csrrs s5, fflags, zero<br> [0x800003ac]:sw a7, 0(s3)<br>      |
|  27|[0x800022e0]<br>0x00000010|- rd : x6<br> - rs1 : f19<br>                                                                                                     |[0x800003c8]:fclass.s t1, fs3<br> [0x800003cc]:csrrs a7, fflags, zero<br> [0x800003d0]:sw t1, 0(a5)<br>      |
|  28|[0x800022e8]<br>0x00000010|- rd : x4<br> - rs1 : f14<br>                                                                                                     |[0x800003e0]:fclass.s tp, fa4<br> [0x800003e4]:csrrs a7, fflags, zero<br> [0x800003e8]:sw tp, 8(a5)<br>      |
|  29|[0x800022f0]<br>0x00000010|- rd : x8<br> - rs1 : f13<br>                                                                                                     |[0x800003f8]:fclass.s fp, fa3<br> [0x800003fc]:csrrs a7, fflags, zero<br> [0x80000400]:sw fp, 16(a5)<br>     |
|  30|[0x800022f8]<br>0x00000010|- rd : x22<br> - rs1 : f24<br>                                                                                                    |[0x80000410]:fclass.s s6, fs8<br> [0x80000414]:csrrs a7, fflags, zero<br> [0x80000418]:sw s6, 24(a5)<br>     |
|  31|[0x80002300]<br>0x00000010|- rd : x11<br> - rs1 : f0<br>                                                                                                     |[0x80000428]:fclass.s a1, ft0<br> [0x8000042c]:csrrs a7, fflags, zero<br> [0x80000430]:sw a1, 32(a5)<br>     |
|  32|[0x80002308]<br>0x00000010|- rd : x26<br> - rs1 : f3<br>                                                                                                     |[0x80000440]:fclass.s s10, ft3<br> [0x80000444]:csrrs a7, fflags, zero<br> [0x80000448]:sw s10, 40(a5)<br>   |
