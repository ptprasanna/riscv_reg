...
|---:|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
|   1|[0x80002310]<br>0x0000000000000010|- opcode : fclass.d<br> - rd : x30<br> - rs1 : f6<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br> |[0x800003b4]:fclass.d t5, ft6<br> [0x800003b8]:csrrs a7, fflags, zero<br> [0x800003bc]:sd t5, 0(a5)<br>      |
|   2|[0x80002320]<br>0x0000000000000002|- rd : x10<br> - rs1 : f25<br> - fs1 == 1 and fe1 == 0x3f8 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                        |[0x800003cc]:fclass.d a0, fs9<br> [0x800003d0]:csrrs a7, fflags, zero<br> [0x800003d4]:sd a0, 16(a5)<br>     |
|   3|[0x80002330]<br>0x0000000000000040|- rd : x5<br> - rs1 : f21<br> - fs1 == 0 and fe1 == 0x3ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                         |[0x800003e4]:fclass.d t0, fs5<br> [0x800003e8]:csrrs a7, fflags, zero<br> [0x800003ec]:sd t0, 32(a5)<br>     |
|   4|[0x80002340]<br>0x0000000000000100|- rd : x23<br> - rs1 : f26<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                        |[0x800003fc]:fclass.d s7, fs10<br> [0x80000400]:csrrs a7, fflags, zero<br> [0x80000404]:sd s7, 48(a5)<br>    |
|   5|[0x80002350]<br>0x0000000000000100|- rd : x21<br> - rs1 : f17<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                        |[0x80000414]:fclass.d s5, fa7<br> [0x80000418]:csrrs a7, fflags, zero<br> [0x8000041c]:sd s5, 64(a5)<br>     |
|   6|[0x80002360]<br>0x0000000000000200|- rd : x22<br> - rs1 : f2<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 1  #nosat<br>                         |[0x8000042c]:fclass.d s6, ft2<br> [0x80000430]:csrrs a7, fflags, zero<br> [0x80000434]:sd s6, 80(a5)<br>     |
|   7|[0x80002370]<br>0x0000000000000200|- rd : x6<br> - rs1 : f23<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000001 and rm_val == 1  #nosat<br>                         |[0x80000444]:fclass.d t1, fs7<br> [0x80000448]:csrrs a7, fflags, zero<br> [0x8000044c]:sd t1, 96(a5)<br>     |
|   8|[0x80002380]<br>0x0000000000000200|- rd : x1<br> - rs1 : f9<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 1  #nosat<br>                          |[0x8000045c]:fclass.d ra, fs1<br> [0x80000460]:csrrs a7, fflags, zero<br> [0x80000464]:sd ra, 112(a5)<br>    |
|   9|[0x80002390]<br>0x0000000000000200|- rd : x16<br> - rs1 : f15<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x8000000000000 and rm_val == 1  #nosat<br>                        |[0x80000480]:fclass.d a6, fa5<br> [0x80000484]:csrrs s5, fflags, zero<br> [0x80000488]:sd a6, 0(s3)<br>      |
|  10|[0x800023a0]<br>0x0000000000000001|- rd : x13<br> - rs1 : f24<br> - fs1 == 1 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                        |[0x800004a4]:fclass.d a3, fs8<br> [0x800004a8]:csrrs a7, fflags, zero<br> [0x800004ac]:sd a3, 0(a5)<br>      |
|  11|[0x800023b0]<br>0x0000000000000080|- rd : x29<br> - rs1 : f8<br> - fs1 == 0 and fe1 == 0x7ff and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                         |[0x800004bc]:fclass.d t4, fs0<br> [0x800004c0]:csrrs a7, fflags, zero<br> [0x800004c4]:sd t4, 16(a5)<br>     |
|  12|[0x800023c0]<br>0x0000000000000002|- rd : x9<br> - rs1 : f16<br> - fs1 == 1 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                         |[0x800004d4]:fclass.d s1, fa6<br> [0x800004d8]:csrrs a7, fflags, zero<br> [0x800004dc]:sd s1, 32(a5)<br>     |
|  13|[0x800023d0]<br>0x0000000000000040|- rd : x18<br> - rs1 : f27<br> - fs1 == 0 and fe1 == 0x7fe and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                        |[0x800004ec]:fclass.d s2, fs11<br> [0x800004f0]:csrrs a7, fflags, zero<br> [0x800004f4]:sd s2, 48(a5)<br>    |
|  14|[0x800023e0]<br>0x0000000000000002|- rd : x11<br> - rs1 : f31<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                        |[0x80000504]:fclass.d a1, ft11<br> [0x80000508]:csrrs a7, fflags, zero<br> [0x8000050c]:sd a1, 64(a5)<br>    |
|  15|[0x800023f0]<br>0x0000000000000040|- rd : x4<br> - rs1 : f5<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                          |[0x8000051c]:fclass.d tp, ft5<br> [0x80000520]:csrrs a7, fflags, zero<br> [0x80000524]:sd tp, 80(a5)<br>     |
|  16|[0x80002400]<br>0x0000000000000000|- rd : x0<br> - rs1 : f28<br> - fs1 == 1 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                         |[0x80000534]:fclass.d zero, ft8<br> [0x80000538]:csrrs a7, fflags, zero<br> [0x8000053c]:sd zero, 96(a5)<br> |
|  17|[0x80002410]<br>0x0000000000000040|- rd : x15<br> - rs1 : f10<br> - fs1 == 0 and fe1 == 0x001 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                        |[0x80000558]:fclass.d a5, fa0<br> [0x8000055c]:csrrs s5, fflags, zero<br> [0x80000560]:sd a5, 0(s3)<br>      |
|  18|[0x80002420]<br>0x0000000000000004|- rd : x27<br> - rs1 : f12<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                        |[0x8000057c]:fclass.d s11, fa2<br> [0x80000580]:csrrs a7, fflags, zero<br> [0x80000584]:sd s11, 0(a5)<br>    |
|  19|[0x80002430]<br>0x0000000000000020|- rd : x14<br> - rs1 : f4<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0xfffffffffffff and rm_val == 1  #nosat<br>                         |[0x80000594]:fclass.d a4, ft4<br> [0x80000598]:csrrs a7, fflags, zero<br> [0x8000059c]:sd a4, 16(a5)<br>     |
|  20|[0x80002440]<br>0x0000000000000004|- rd : x17<br> - rs1 : f1<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                         |[0x800005b8]:fclass.d a7, ft1<br> [0x800005bc]:csrrs s5, fflags, zero<br> [0x800005c0]:sd a7, 0(s3)<br>      |
|  21|[0x80002450]<br>0x0000000000000020|- rd : x31<br> - rs1 : f13<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000002 and rm_val == 1  #nosat<br>                        |[0x800005dc]:fclass.d t6, fa3<br> [0x800005e0]:csrrs a7, fflags, zero<br> [0x800005e4]:sd t6, 0(a5)<br>      |
|  22|[0x80002460]<br>0x0000000000000004|- rd : x7<br> - rs1 : f29<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                         |[0x800005f4]:fclass.d t2, ft9<br> [0x800005f8]:csrrs a7, fflags, zero<br> [0x800005fc]:sd t2, 16(a5)<br>     |
|  23|[0x80002470]<br>0x0000000000000020|- rd : x28<br> - rs1 : f11<br> - fs1 == 0 and fe1 == 0x000 and fm1 == 0x0000000000001 and rm_val == 1  #nosat<br>                        |[0x8000060c]:fclass.d t3, fa1<br> [0x80000610]:csrrs a7, fflags, zero<br> [0x80000614]:sd t3, 32(a5)<br>     |
|  24|[0x80002480]<br>0x0000000000000008|- rd : x12<br> - rs1 : f30<br> - fs1 == 1 and fe1 == 0x000 and fm1 == 0x0000000000000 and rm_val == 1  #nosat<br>                        |[0x80000624]:fclass.d a2, ft10<br> [0x80000628]:csrrs a7, fflags, zero<br> [0x8000062c]:sd a2, 48(a5)<br>    |
|  25|[0x80002490]<br>0x0000000000000010|- rd : x26<br> - rs1 : f7<br>                                                                                                            |[0x8000063c]:fclass.d s10, ft7<br> [0x80000640]:csrrs a7, fflags, zero<br> [0x80000644]:sd s10, 64(a5)<br>   |
|  26|[0x800024a0]<br>0x0000000000000010|- rd : x20<br> - rs1 : f22<br>                                                                                                           |[0x80000654]:fclass.d s4, fs6<br> [0x80000658]:csrrs a7, fflags, zero<br> [0x8000065c]:sd s4, 80(a5)<br>     |
|  27|[0x800024b0]<br>0x0000000000000010|- rd : x2<br> - rs1 : f20<br>                                                                                                            |[0x8000066c]:fclass.d sp, fs4<br> [0x80000670]:csrrs a7, fflags, zero<br> [0x80000674]:sd sp, 96(a5)<br>     |
|  28|[0x800024c0]<br>0x0000000000000010|- rd : x24<br> - rs1 : f19<br>                                                                                                           |[0x80000684]:fclass.d s8, fs3<br> [0x80000688]:csrrs a7, fflags, zero<br> [0x8000068c]:sd s8, 112(a5)<br>    |
|  29|[0x800024d0]<br>0x0000000000000010|- rd : x25<br> - rs1 : f0<br>                                                                                                            |[0x8000069c]:fclass.d s9, ft0<br> [0x800006a0]:csrrs a7, fflags, zero<br> [0x800006a4]:sd s9, 128(a5)<br>    |
|  30|[0x800024e0]<br>0x0000000000000010|- rd : x8<br> - rs1 : f14<br>                                                                                                            |[0x800006b4]:fclass.d fp, fa4<br> [0x800006b8]:csrrs a7, fflags, zero<br> [0x800006bc]:sd fp, 144(a5)<br>    |
|  31|[0x800024f0]<br>0x0000000000000010|- rd : x3<br> - rs1 : f18<br>                                                                                                            |[0x800006cc]:fclass.d gp, fs2<br> [0x800006d0]:csrrs a7, fflags, zero<br> [0x800006d4]:sd gp, 160(a5)<br>    |
|  32|[0x80002500]<br>0x0000000000000010|- rd : x19<br> - rs1 : f3<br>                                                                                                            |[0x800006e4]:fclass.d s3, ft3<br> [0x800006e8]:csrrs a7, fflags, zero<br> [0x800006ec]:sd s3, 176(a5)<br>    |
